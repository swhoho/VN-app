...
export const translations = {
  en: {
    ...
    uploadVn: "Upload Visual Novel",
    thumbnail: "Thumbnail",
    uploadSquareThumbnail: "Upload Square Thumbnail",
    uploadVerticalThumbnail: "Upload Vertical Thumbnail",
    details: "Details",
    title: "Title",
    ...
    dragOrSelectFiles: "Drag or select files",
    episode: "Episode",
    addEpisode: "Add Episode",
    startFromEpisode1: "Start from Episode 1",
    ...
    statsLoadError: "Failed to load user statistics:",
    noItemsInGenre: "No items found in this genre.",
    noDescriptionAvailable: "No description available",
    noCanvasItems: "No canvas items yet.",
    ...
    unlockWithPremium: "Unlock with Premium membership or Points",
    ...
    comingSoonDescription: "This feature is currently under development. Stay tuned for updates!",
    gotItButton: "Got it!",
  ...
  ko: {
    ...
    uploadVn: "비주얼 노벨 업로드",
    thumbnail: "썸네일",
    uploadSquareThumbnail: "정사각형 썸네일 업로드",
    uploadVerticalThumbnail: "세로형 썸네일 업로드",
    details: "세부 정보",
    title: "제목",
    description: "설명",
    ...
    workUpload: "작품 업로드",
    externalUrl: "외부 URL",
    dragOrSelectFiles: "파일을 드래그하거나 선택하세요",
    episode: "에피소드",
    addEpisode: "에피소드 추가",
    startFromEpisode1: "에피소드 1부터 시작하세요",
    agreeToTerms: "정책 및 약관에 동의합니다",
    createSeries: "시리즈 생성",
    
    // 오류 메시지
    error: "오류",
    loginError: "로그인 중 문제가 발생했습니다. 다시 시도해주세요.",
    statsLoadError: "사용자 통계 로딩 실패:",
    noItemsInGenre: "이 장르에서 아이템을 찾을 수 없습니다.",
    noDescriptionAvailable: "설명을 사용할 수 없습니다",
    noCanvasItems: "아직 캔버스 아이템이 없습니다.",
    
    // 페이지 제목 및 네비게이션
    pageNotFound: "404 페이지를 찾을 수 없습니다",
    didYouForget: "라우터에 페이지를 추가하는 것을 잊으셨나요?",
    novelNotFound: "소설을 찾을 수 없습니다",
    goBack: "뒤로 가기",
    visualNovel: "비주얼 노벨",
    complete: "완료",
    synopsis: "줄거리",
    readingProgress: "독서 진행률",
    chapterXofY: "챕터 {current} / {total}",
    ...
    unlockWithPremium: "프리미엄 멤버십 또는 포인트로 잠금 해제",
    ...
    comingSoonDescription: "이 기능은 현재 개발 중입니다. 업데이트를 기다려 주세요!",
    gotItButton: "확인!",
